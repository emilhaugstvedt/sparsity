...
for n in range(n_models):
    ...
    run = neptune.init_run(
        project="emilhaugstvedt/dense-net",
        name=f"model_{n+1}",
    ...
    torch.save(model, f"../models/{dataset}/dense_net/model_{n+1}.pickle")
    torch.save(best_model, f"../models/{dataset}/dense_net/best_model_{n+1}.pickle")
    #torch.save(swa_model.state_dict(), f"../models/{dataset}/dense_net/swa_model_{n+1}.pickle")
    #torch.save(best_swa_model.state_dict(), f"../models/{dataset}/dense_net/best_swa_model_{n+1}.pickle")