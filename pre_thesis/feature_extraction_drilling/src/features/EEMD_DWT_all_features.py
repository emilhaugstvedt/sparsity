...
def get_column_names(feature, select_imfs, n_levels):
    ...
    for n in select_imfs:
        base_1 = f'{feature}_EEMD_DWT_IMF_{n}_'
...
def main():
    ...
    for feature in features:
        ...
        print(df.shape)
        print(len(get_column_names(feature, select_imfs=[1, 2, 3, 4, 5], n_levels=5)))
        df.columns = get_column_names(feature, select_imfs=[1,2,3,4,5], n_levels=5)
        df.to_csv(f'features/new_features/{feature}/EEMD_DWT_complete_samples.csv')
